...
func Stats() string {
	...
	return fmt.Sprintf("Roles: %v\nSkills: %v\nStats: %v\n", randomRole, randomSkill, statLines)
}

func Card(name, role, skill string) string {
	borderCard := "═══════════════════════════════════════════════════════════════"
	dragonNameplate := fmt.Sprintf(`
            🐉 ══════════════════════════════════════════ 🐉
          ╔═══════════════════════════════════════════════════╗
        ╔═╣           ⚔️  LEGEND OF THE REALM  ⚔️           ╠═╗
      ╔═╝ ╚═══════════════════════════════════════════════════╝ ╚═╗
    ╔═╝     ╭─────────────────────────────────────────────╮     ╚═╗
  ╔═╝       │  🏰 Name: %-30s │       ╚═╗
╔═╝         │  ⚡ Role: %-30s │         ╚═╗
║           │  ✨ Skill: %-29s │           ║
║           │  					 │           ║
╚═╗         │  🗡️  Level: Legendary Master          │         ╔═╝
  ╚═╗       ╰─────────────────────────────────────────────╯       ╔═╝
    ╚═╗     ⚔️ "By sword and spell, destiny unfolds" ⚔️     ╔═╝
      ╚═╗ ╔═══════════════════════════════════════════════════╗ ╔═╝
        ╚═╣    🔥 Forged in the fires of adventure 🔥    ╠═╝
          ╚═══════════════════════════════════════════════════╝
            🐲 ══════════════════════════════════════════ 🐲`, name, role, skill)

	return fmt.Sprintf("%s%s\n%s", borderCard, dragonNameplate, borderCard)
}
